...
export default function RecentTransactions({ transactions, searchTerm = "" }: RecentTransactionsProps) {
    return (
        <div className="bg-white dark:bg-black p-6 rounded-lg border border-gray-200 dark:border-gray-800 col-span-1 md:col-span-2 lg:col-span-4">
            ...
            <div className="md:hidden space-y-4">
                {transactions.length > 0 ? (
                    transactions.map((t) => (
                        <div key={t.id} className="flex justify-between items-start p-4 bg-gray-50 dark:bg-gray-900/30 rounded-lg border border-gray-100 dark:border-gray-800">
