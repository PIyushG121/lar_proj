...
export default function HelpSearchHero() {
    ...
    const handleChipClick = (action: string) => {
        switch (action) {
            ...
            case "Billing History":
                router.visit("/dashboard/business/transactions");
                break;
            default:
                setQuery(action);
        }
    ...
    const navRoutes = [
        ...
        { name: "Transactions", path: "/dashboard/business/transactions", category: "Navigation" },
        { name: "Invoices", path: "/dashboard/business/transactions?tab=invoices", category: "Navigation" },
        { name: "Bills", path: "/dashboard/business/transactions?tab=bills", category: "Navigation" },
