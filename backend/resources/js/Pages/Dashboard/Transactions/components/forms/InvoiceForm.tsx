            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        ...
                        className={`w-full px-4 py-2 bg-gray-50 dark:bg-gray-950/50 border rounded-lg text-sm outline-none focus:border-primary ${errors.invoiceId ? 'border-red-500' : 'border-gray-100 dark:border-gray-800'}`}
                        placeholder="INV-001"
                    />
                    {errors.invoiceId && <p className="text-xs text-red-500 mt-1">{errors.invoiceId}</p>}
                </div>
                <div>
