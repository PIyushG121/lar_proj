            ...
            <div className="bg-white dark:bg-[#0A0A0A] border border-gray-200 dark:border-white/5 rounded-2xl p-6 h-fit shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none transition-all duration-300">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                    <div className="p-2 rounded-lg bg-emerald-500/10 text-emerald-500">
                        <span className="material-symbols-outlined !text-2xl leading-none">headset_mic</span>
                    </div>
                    Contact Support
                </h3>
                <div className="space-y-4">
                    ...
                    <div className="p-4 rounded-xl bg-gradient-to-br from-gray-50 to-white dark:from-[#151515] dark:to-[#101010] border border-gray-200 dark:border-border-dark flex flex-col gap-3 shadow-sm">
                        ...
                        <button
                            ...
                            className="w-full py-2 border border-gray-200 dark:border-white/10 hover:border-primary/50 hover:text-primary text-gray-600 dark:text-gray-300 text-xs font-bold rounded-lg transition-all"
                        >
                            Send Email
                        </button>
                    </div>
