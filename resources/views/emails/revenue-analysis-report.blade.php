                                ...
                                <td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="60%">
                                                <div style="background:#e5e7eb;border-radius:8px;height:24px;overflow:hidden;">
                                                    <div style="background:linear-gradient(90deg,#0284c7,#0ea5e9);height:100%;width:{{ min(100, ($totalRevenue / max($totalRevenue, $totalExpense, 1)) * 100) }}%;border-radius:8px;"></div>
                                                </div>
                                            </td>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:12px;">
                                        <tr>
                                            ...
                                            <td width="60%">
                                                <div style="background:#e5e7eb;border-radius:8px;height:24px;overflow:hidden;">
                                                    <div style="background:linear-gradient(90deg,#ea580c,#f97316);height:100%;width:{{ min(100, ($totalExpense / max($totalRevenue, $totalExpense, 1)) * 100) }}%;border-radius:8px;"></div>
                                                </div>
                                            </td>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="60%">
                                                <div style="background:#e5e7eb;border-radius:8px;height:24px;overflow:hidden;">
                                                    <div style="background:linear-gradient(90deg,#16a34a,#22c55e);height:100%;width:{{ min(100, abs($netProfit / max($totalRevenue, $totalExpense, 1)) * 100) }}%;border-radius:8px;"></div>
                                                </div>
                                            </td>
                            ...
                            <tr style="background:{{ $index % 2 == 0 ? '#ffffff' : '#f9fafb' }};">
                                ...
                                <td style="padding:10px 12px;text-align:center;border-bottom:1px solid #f3f4f6;">
                                    <span style="display:inline-block;padding:4px 10px;border-radius:12px;font-size:11px;font-weight:600;
                                        {{ $transaction->type === 'Revenue' ? 'background:#d1fae5;color:#065f46;' : 'background:#fed7aa;color:#9a3412;' }}">
                                        {{ $transaction->type === 'Revenue' ? 'Income' : 'Expense' }}
                                    </span>
                                </td>
                                <td style="padding:10px 12px;text-align:right;font-size:13px;font-weight:600;border-bottom:1px solid #f3f4f6;
                                    {{ $transaction->type === 'Revenue' ? 'color:#16a34a;' : 'color:#ea580c;' }}">
