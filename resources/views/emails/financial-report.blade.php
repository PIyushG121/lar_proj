                    ...
                    <tr>
                        <td style="padding:30px;color:#333;">
                            ...
                            <p style="font-size:14px;line-height:1.7;margin:0 0 24px;color:#555;">
                                Please find your <strong>{{ $reportType }}</strong> for the period
                                <strong>{{ $startDate }} – {{ $endDate }}</strong> below.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 30px;">
                                <tr>
                                    <td colspan="3" style="padding-bottom:12px;">
                                        <h2 style="margin:0;font-size:18px;color:#333;font-weight:bold;">📈 Key Metrics</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <!-- Revenue Card -->
                                        ...
                                        <table width="100%" style="background:#f0f9ff;border-radius:10px;border:1px solid #e0f2fe;">
                                            <tr>
                                                <td style="padding:20px;text-align:center;">
                                                    <p style="margin:0;font-size:12px;color:#666;font-weight:600;text-transform:uppercase;">
                                                        Total Revenue
                                                    </p>
                                                    <h3 style="margin:8px 0 0;color:#0284c7;font-size:24px;font-weight:bold;">
                                        ...
                                        <table width="100%" style="background:#fff7ed;border-radius:10px;border:1px solid #fed7aa;">
                                            <tr>
                                                <td style="padding:20px;text-align:center;">
                                                    ...
                                                    <h3 style="margin:8px 0 0;color:#ea580c;font-size:24px;font-weight:bold;">
                                        ...
                                        <table width="100%" style="background:#ecfdf5;border-radius:10px;border:1px solid #a7f3d0;">
                                            <tr>
                                                <td style="padding:20px;text-align:center;">
                                                    ...
                                                    <h3 style="margin:8px 0 0;color:#16a34a;font-size:24px;font-weight:bold;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 30px;background:#f8fafc;border-radius:10px;padding:20px;">
                                <tr>
                                    <td>
                                        ...
                                        $revenueBarStyle = "background:linear-gradient(90deg,#0284c7,#0ea5e9);height:100%;border-radius:8px;width:$revenuePercentage%;";
                                        @endphp
                                        ...
                                        $expenseBarStyle = "background:linear-gradient(90deg,#ea580c,#f97316);height:100%;border-radius:8px;width:$expensePercentage%;";
                                        @endphp
                                        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:12px;">
                                            <tr>
                                        ...
                                        $profitBarStyle = "background:linear-gradient(90deg,#16a34a,#22c55e);height:100%;border-radius:8px;width:$profitPercentage%;";
                                        @endphp
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
                                <tr>
                                    <td style="padding-bottom:12px;">
                                        <h2 style="margin:0;font-size:18px;color:#333;font-weight:bold;">📋 Transaction Details</h2>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
                                ...
                                <tr style="background:#f8fafc;">
                                    ...
                                    <th style="padding:12px;text-align:left;font-size:11px;font-weight:700;color:#666;text-transform:uppercase;border-bottom:2px solid #e5e7eb;">Client/Vendor</th>
                                ...
                                $amountCellStyle = "padding:10px 12px;text-align:right;font-size:13px;font-weight:600;border-bottom:1px solid #f3f4f6;$amountStyle";
                                $typeBadgeStyle = "display:inline-block;padding:4px 10px;border-radius:12px;font-size:11px;font-weight:600;$typeStyle";
                                @endphp
                                ...
                                <tr style="background:#fef3c7;">
                                    <td colspan="4" style="padding:14px 12px;text-align:right;font-size:14px;font-weight:700;color:#92400e;border-top:2px solid #ff9f1a;">
                                        NET PROFIT/LOSS
                                    </td>
                                    <td style="padding:14px 12px;text-align:right;font-size:16px;font-weight:700;color:#ff9f1a;border-top:2px solid #ff9f1a;">
                                        ₹{{ number_format($netProfit, 2) }}
                                    </td>
                                </tr>
                            </table>
